				...
				echo "<tr>";
					...
					echo "<td>";
						echo "<a href = 'data_output.php?search=$row[S_no]'>";
							echo "<img src='view.png' style='width:30px;height:30px;'>";
						echo "</a>";	
					echo "</td>";	
					echo "<td>";
						echo "<a href = 'update.php?search=$row[S_no]'>";
							echo "<img src='edit.png' style='width:30px;height:30px;'>";
						echo "</a>";	
					echo "</td>";	
					echo "<td>";
						echo "<a href = 'delete.php?search=$row[S_no]'>";
							echo "<img src='delete.png' style='width:30px;height:30px;'>";
						echo "</a>";	
					echo "</td>";	
				echo "</tr>"; 
				}
