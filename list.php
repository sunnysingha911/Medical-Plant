...
$list = $_GET['list'];
				...
				$sql =  "select * from plantinfo where habit = '$list' order by Botanical_name limit $start_from, $node";
				...
				$sql2 = "select * from plantinfo where habit = '$list'"; 
				...
				echo "<br>"."<center>"."<div>";
				echo "<a href='list.php?page=1&list=$list'>".'|<'."</a> "; 

for ($i=1; $i<=$total_pages; $i++) { 
            echo "<a href='list.php?page=".$i."&list=$list'>".$i."</a> "; 
}; 
echo "<a href='list.php?page=$total_pages&list=$list'>".'>|'."</a> "; 
